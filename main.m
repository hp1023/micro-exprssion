...
load name_class;      % name of each class
addpath ConfusionMatrices; % package for computing confusion matrix
x = predict_label(1:100);
num = [7 7 7];
[confusion_matrix]=compute_confusion_matrix(x,num,name_class);
...
num=[3 3 3];
name=cell(1,3);
name{1}='negative';name{2}='positive';name{3}='surprise';
compute_confusion_matrix(B , num, name)
